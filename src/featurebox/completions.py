"""Shell completion generation for featurebox."""
...
def generate_bash() -> str:
    ...
    return '''# featurebox bash completion
_featurebox_completions() {
    local cur prev opts
    COMPREPLY=()
...
complete -F _featurebox_completions featurebox
complete -F _featurebox_completions fb
'''


def generate_zsh() -> str:
    """Generate zsh completion script."""
    return '''#compdef featurebox fb
...
_featurebox() {
    ...
    commands=(
        ...
        'init:Initialize .featurebox.toml in current repo'
...
compdef _featurebox featurebox fb
'''


def generate_fish() -> str:
    """Generate fish completion script."""
    return '''# featurebox fish completions

# Disable file completions for all subcommands
complete -c featurebox -f
complete -c fb -f

# Main commands
complete -c featurebox -n "__fish_use_subcommand" -a "start" -d "Start or resume a feature worktree"
complete -c featurebox -n "__fish_use_subcommand" -a "cleanup" -d "Clean up worktree, branch, tmux session, docker"
complete -c featurebox -n "__fish_use_subcommand" -a "status" -d "Interactive TUI - view all worktrees"
complete -c featurebox -n "__fish_use_subcommand" -a "list" -d "Simple list of worktrees (non-interactive)"
complete -c featurebox -n "__fish_use_subcommand" -a "init" -d "Initialize .featurebox.toml in current repo"
complete -c featurebox -n "__fish_use_subcommand" -a "completions" -d "Generate shell completions"
...
complete -c fb -n "__fish_use_subcommand" -a "init" -d "Initialize .featurebox.toml in current repo"
complete -c fb -n "__fish_use_subcommand" -a "completions" -d "Generate shell completions"

# cleanup subcommand
complete -c featurebox -n "__fish_seen_subcommand_from cleanup" -l force -s f -d "Force removal"
complete -c fb -n "__fish_seen_subcommand_from cleanup" -l force -s f -d "Force removal"

# completions subcommand
complete -c featurebox -n "__fish_seen_subcommand_from completions" -a "bash zsh fish"
...
# Or save to a file:
featurebox completions bash > ~/.local/share/bash-completion/completions/featurebox""",
        "zsh": """# Add to ~/.zshrc:
eval "$(featurebox completions zsh)"

# Or save to a file:
featurebox completions zsh > ~/.zfunc/_featurebox
